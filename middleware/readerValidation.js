    ...
    create: [
        ...
        body("password")
            .custom((value, { req }) => {
                ...
                const reader_name = req.body.reader_name.toLowerCase()
                if (value.toLowerCase().includes(reader_name)) {
                    throw new Error("Password cannot contain parts of your username.")
                }
